# Today was a challenge day.. Didn't really feel much up to it honestly. I made a few minor changes to the original code. Hoping I can do more later on.

name = input("What's your name? ")
print()

if name =="Madisen" or name == "madisen":
 ...
 if DOW == "thursday" or DOW == "Thursday":
   pryour week is almost over!")
 if DOW == "friday" or DOW == "Friday":
   print(name, "It's FRIDAY!")

elif name == "Layla" or name== "layla":
 DOW = input("What is the day of the week? ")
 if DOW == "monday" or DOW == "Monday":
   print("It is going to be a great Monday,", name)
 if DOW == "tuesday" or DOW == "Tuesday":
